...
public class ReadCube : MonoBehaviour
{
    ...
    public void ReadState()
    {
        ...
        // Then update the map with the found positions
        cubeMap.Set();
    }

    void SetRayTransforms()
    {
        // populate ray lists with raycasts originating from the transform, angled towards the cube
    ...
    {
        // Ray count is used to name the rays so we can be sure they're in the right order
        int rayCount = 0;
